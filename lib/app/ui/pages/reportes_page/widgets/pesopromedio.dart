...
class Pesopromedio extends StatelessWidget {
  const Pesopromedio({Key? key}) : super(key: key);
    ...
    return Column(
      children: [
         Row(
          ...
          children: [
             Text("Reporte de peso promedio",style: Theme.of(context).textTheme.titleLarge,),
              Row(children: [
                Icon(Icons.book),
                Text("Exportar"),
